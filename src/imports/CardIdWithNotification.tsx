import svgPaths from "./svg-zh5p0o1ojd";
...
function NoticeMessage() {
  return (
    <div className="relative shrink-0 w-full" data-name="notice-message">
      <div className="flex flex-row items-center size-full">
        <div className="content-stretch flex items-center pr-[24px] relative w-full">
          <p className="flex-[1_0_0] font-['Roboto:SemiBold',sans-serif] font-semibold leading-[24px] min-h-px min-w-px relative text-[#1e1e1e] text-[16px]" style={{ fontVariationSettings: "'wdth' 100" }}>
            Требуются доработки
          </p>
        </div>
      </div>
...
function Content() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-center justify-center min-h-px min-w-px relative" data-name="content">
      <NoticeMessage />
      <div className="font-['Roboto:Regular',sans-serif] font-normal leading-[0] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.85)] w-full" style={{ fontVariationSettings: "'wdth' 100" }}>
        <p className="leading-[22px] mb-0">У объявления не заполнены поля:</p>
        <ul className="list-disc">
          <li className="mb-0 ms-[21px]">
            <span className="leading-[22px]">Цвет</span>
          </li>
          <li className="ms-[21px]">
            <span className="leading-[22px]">Состояние</span>
          </li>
        </ul>
      </div>
    </div>
...
function Notification() {
  return (
    <div className="bg-[#f9f1e6] content-stretch flex gap-[16px] items-start px-[16px] py-[12px] relative rounded-[8px] shadow-[0px_3px_6px_0px_rgba(0,0,0,0.12),0px_6px_16px_0px_rgba(0,0,0,0.08),0px_9px_28px_0px_rgba(0,0,0,0.05)] shrink-0 w-[512px]" data-name="Notification">
      <div className="overflow-clip relative shrink-0 size-[18px]" data-name="exclamation-circle">
        <div className="absolute inset-[6.25%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 15.75 15.75">
            <path d={svgPaths.p513ba00} fill="var(--fill-0, #FFA940)" id="Vector" />
          </svg>
        </div>
      </div>
      <Content />
...
function Component8() {
  return (
    <div className="content-stretch flex flex-col gap-[36px] items-start relative self-stretch shrink-0 w-[527px]" data-name="Секция">
      <Notification />
      <Component9 />
    </div>
  );
...
function Component() {
  return (
    <div className="absolute h-[1177px] left-[-164px] top-[-104px] w-[1728px]" data-name="Просмотр объявления (требуются доработки)">
...
export default function CardIdWithNotification() {
  return (
    <div className="bg-[#f1f1f1] relative size-full" data-name="/card/[id] with Notification">
      <Component />
    </div>
  );
}