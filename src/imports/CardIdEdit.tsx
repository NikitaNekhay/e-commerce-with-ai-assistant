import svgPaths from "./svg-3vfinj8ej0";
...
function Component1() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0" data-name="Категория">
      ...
      <div className="bg-white content-stretch flex items-start px-[12px] py-[4px] relative rounded-[8px] shrink-0 w-[256px]" data-name="Select">
...
function Placeholder() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px overflow-clip relative" data-name="placeholder">
      <div className="h-[18px] relative shrink-0 w-px" data-name="Input-Addon/Cursor">
        <div className="-translate-y-1/2 absolute bg-black h-[18px] left-0 top-1/2 w-px" data-name="cursor" />
      </div>
...
function Input1() {
  return (
    <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="input">
      ...
      <div aria-hidden="true" className="absolute border border-[#40a9ff] border-solid inset-0 pointer-events-none rounded-[8px] shadow-[0px_0px_0px_2px_rgba(24,144,255,0.2)]" />
    </div>
  );
}
...
function Wrap() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-start min-h-px min-w-px relative rounded-[8px] z-[1]" data-name="wrap">
      <Input1 />
    </div>
  );
}
              ...
              <div className="content-stretch flex gap-[4px] items-center px-[12px] py-[5px] relative w-full">
                <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px overflow-clip relative" data-name="placeholder">
                  <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#1e1e1e] text-[14px] whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
                    <p className="leading-[22px]">64000</p>
                  </div>
                </div>
                <div className="overflow-clip relative shrink-0 size-[14px]" data-name="input-suffix">
                  <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 size-[14px] top-1/2" data-name="Union">
    ...
    <div className="content-stretch flex flex-col gap-[12px] isolate items-start relative shrink-0 w-[456px]" data-name="Field Type">
      ...
      <div className="content-stretch flex flex-col items-start relative shrink-0 w-full z-[3]" data-name="Vertical-Form-Item/Input">
        ...
        <button className="bg-white cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="Field">
          <div className="content-stretch flex items-center overflow-clip relative rounded-[inherit] w-full">
            <div className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[8px]" data-name="input">
              ...
              <div className="flex flex-row items-center size-full">
                <div className="content-stretch flex gap-[4px] items-center px-[12px] py-[5px] relative w-full">
                  <div className="content-stretch flex flex-[1_0_0] items-center min-h-px min-w-px overflow-clip relative" data-name="placeholder">
                    <div className="flex flex-col font-['Roboto:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[14px] text-[rgba(0,0,0,0.25)] text-left whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
          ...
          <div aria-hidden="true" className="absolute border border-[#ffa940] border-solid inset-0 pointer-events-none rounded-[8px]" />
        </button>
      </div>
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Форма">
      ...
      <div className="-translate-y-1/2 absolute right-[498.91px] size-[12px] top-[calc(50%-132.57px)]" data-name="icon">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.1778 6.85737">
          <path d={svgPaths.p19c1b300} fill="var(--fill-0, black)" fillOpacity="0.25" id="icon" />
        </svg>
      </div>
      <div className="-translate-y-1/2 absolute right-[498.91px] size-[12px] top-[calc(50%+163.43px)]" data-name="icon">
        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10.1778 6.85737">
          <path d={svgPaths.p6ee2700} fill="var(--fill-0, black)" fillOpacity="0.25" id="icon" />
        </svg>
      </div>
    </div>
  );
...
function Button1() {
  return (
    <div className="bg-[#f9f1e6] content-stretch flex gap-[10px] h-[32px] items-center justify-center overflow-clip px-[7px] relative rounded-[8px] shrink-0 w-[175px]" data-name="Button">
      <IconWrapper1 />
      <p className="font-['Roboto:Regular',sans-serif] font-normal leading-[22px] relative shrink-0 text-[#ffa940] text-[14px] text-center whitespace-nowrap" style={{ fontVariationSettings: "'wdth' 100" }}>
        Улучшить описание
      </p>
    ...
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-[942px]" data-name="Описание">
      ...
      <button className="bg-white cursor-pointer relative rounded-[8px] shrink-0 w-full" data-name="Textarea">
        ...
        <div className="content-stretch flex flex-col items-start px-[16px] py-[8px] relative w-full">
          <p className="font-['Inter:Regular',sans-serif] font-normal leading-[1.4] not-italic relative shrink-0 text-[16px] text-[rgba(0,0,0,0.85)] text-left w-full">{`Продаю свой MacBook Pro 16" (2021) на чипе M1 Pro. Состояние отличное, работал бережно. Мощности хватает на всё: от сложного монтажа до кода, при этом ноутбук почти не греется.`}</p>
...
export default function CardIdEdit() {
  return (
    <div className="bg-[#f1f1f1] relative size-full" data-name="/card/[id]/edit">
      <Component />
    </div>
  );
}